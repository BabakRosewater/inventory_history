...
Downloads dtfeed MP16607.csv (tries http + https),
writes:
  - data/latest/MP16607.csv
  - data/snapshots/YYYY-MM-DD/MP16607_YYYYmmdd_HHMMSSZ.csv.gz
  - data/manifest.csv (append one row per NEW raw-feed change)

Notes:
- If the raw feed bytes are unchanged (sha256 match), we do nothing.
"""
